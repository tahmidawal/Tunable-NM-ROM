...
Table~\ref{tab:headline} markers.
...
Table~\ref{tab:headline}, or the confirmed first-step form of the
$4096^2$ Burgers lattice rule. The $4096^2$ Burgers fast speedup in
Table~\ref{tab:headline} does not divide the Newton time printed here;
it divides \nBhFastFom.}
...
Table~\ref{tab:headline} (it misses the 1\,\% all-times target;
...
formed. The shallow masked-autoencoder NM-LSPG of \citet{KimChoi2022NMROM}
...
\ref{tab:config3d} and every row of Table~\ref{tab:tunability}, with the
