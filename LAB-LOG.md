...
<!--
BACKFILL FRAGMENT — splice above the `## 2026-08-16` header in LAB-LOG.md.
Reconstructed 2026-08-18 from branch history, per-cell READMEs and runs/**.json.
Where a README and a JSON disagreed the JSON was taken and the gap noted inline.
Numbers with no recoverable artefact are marked "not recorded" rather than guessed.
-->
