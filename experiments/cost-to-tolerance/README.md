...
_every expected primary cell is present exactly once, and every panel ran on GPU in f64 at matmul precision `highest`._
...
| burgers2d | consolidation     | b61ba89 | NVIDIA A100 80GB PCIe | pax049 | gpu         | 2516905   | highest          | yes | 0    | 16      | 7         | 2        | yes      | ctol_consol_b/out/ctol_burgers_consolidated.json |
...
| poisson2d | consolidation     | b61ba89 | NVIDIA A100 80GB PCIe | pax007 | gpu         | 2516900   | highest          | yes | 0    | 16      | 7         | 2        | yes      | ctol_consol_p/out/ctol_poisson_consolidated.json |
...
| pod    | 512 | 0.68 | 0.82      | 1.15 | 0.92      | 0.81 | 0.77      | 1.04 | 0.29 |
...
| 1e-01 | pod    | 512 | 1.62 | 1.69 | 2.28 | 1.00 | below res | below res | below res | below res |
...
| 1e-02 | pod    | 512 | 0.74 | 0.89 | 1.24 | 1.00 | 0.88      | 0.84      | 1.13      | 0.32      |
...
| 1e-03 | pod    | 512 | 0.66 | 0.80 | 1.10 | 1.00 | 0.78      | 0.75      | 0.98      | 0.29      |
...
| 1e-01 | pod    | 512 | 1.21 | 1.26 | 1.49 | 1.00 | 0.54 | 0.64 | 0.70 | 1.03 |
...
| 1e-02 | pod    | 512 | 0.83 | 0.94 | 1.14 | 1.00 | 0.93 | 0.92 | 1.10 | 0.84 |
...
| 1e-03 | pod    | 512 | 0.78 | 0.87 | 1.06 | 1.00 | 0.87 | 0.86 | 1.02 | 0.79 |
...
| pod    | 512 | 0.68 | 0.71      | 0.95      | 0.42      | below res | below res | below res | below res |
...
| pod    | 512 | 0.69 | 0.83 | 1.15 | 1.04 | 0.81  | 0.78  | 1.03  | 0.30  |
...
| pod    | 512 | 3.6  | 3.6  | 3.6  | 3.6  | 3.7  | 3.7  | 4.0  | 3.7  |
...
| pod    | 512 | 3.6  | 3.4 | 3.2 | 3.2 | 2.8  | 2.4  | 2.0  | 2.0  |
...
| pod    | 512 | 3.6  | 3.6  | 3.6  | 3.6  | 3.7  | 3.7  | 4.0  | 3.9  |
...
| pod    | 512 | 4.565e-01 | 2.906e-01 | 2.193e-01 | 1.761e-01 | 1.282e-01 | 1.000e-01 | 6.602e-02 | 5.032e-02 |
...
| 1e-01 | pod    | 512 | 100 | 88  | 81  | 75  | 44   | 25   | 0    | 0    |
...
| 1e-02 | pod    | 512 | 100 | 100 | 100 | 100 | 100  | 100  | 100  | 88   |
...
| 1e-03 | pod    | 512 | 100 | 100 | 100 | 100 | 100  | 100  | 100  | 100  |
...
| 1e-01 | pod    | 512 | 9.19e-01 | 8.53e-01 | 8.14e-01 | 7.69e-01 | 7.09e-01 | 6.49e-01 | 5.59e-01 | 5.03e-01 |
...
| 1e-02 | pod    | 512 | 9.19e-01 | 8.53e-01 | 8.14e-01 | 7.69e-01 | 7.09e-01 | 6.49e-01 | 5.59e-01 | 5.03e-01 |
...
| 1e-03 | pod    | 512 | 9.19e-01 | 8.53e-01 | 8.14e-01 | 7.69e-01 | 7.09e-01 | 6.49e-01 | 5.59e-01 | 5.03e-01 |
...
| 512 | pod    | 32 | 256 | 1024 | 1e-01 | 1.12          | 5.032e-02  | 2.0       | 0          | 18.13              | 82.9        |
...
| 512 | pod    | 24 | 64  | 256  | 1e-01 | 0.77          | 6.602e-02  | 2.0       | 0          | 26.50              | 121.1       |
| 512 | pod    | 32 | 256 | 1024 | 1e-01 | 1.12          | 5.032e-02  | 2.0       | 0          | 18.13              | 82.9        |
| 512 | pod    | 32 | 256 | 1024 | 1e-02 | 1.35          | 5.032e-02  | 3.7       | 88         | 15.12              | 69.1        |
| 512 | pod    | 32 | 256 | 1024 | 1e-03 | 1.35          | 5.032e-02  | 3.9       | 100        | 15.05              | 68.8        |
<!-- END GENERATED: paretodep_poisson2d -->

<!-- BEGIN GENERATED: paretodep_burgers2d -->
| N   | method | k  | M   | m    | tau   | time ms (e2e) | err rel-L2 | jac evals | censored % | x iso-accuracy FOM | x exact FOM |
|-----|--------|----|-----|------|-------|---------------|------------|-----------|------------|--------------------|-------------|
| 32  | coord  | 6  | 64  | 256  | 1e-01 | 103.27        | 2.099e-02  | 129.9     | 6          | 0.17               | 1.9         |
| 32  | coord  | 6  | 64  | 256  | 1e-02 | 271.10        | 1.692e-02  | 304.2     | 100        | 0.06               | 0.7         |
| 32  | coord  | 8  | 64  | 256  | 1e-02 | 333.66        | 1.623e-02  | 320.2     | 100        | 0.05               | 0.6         |
...
| 32  | pod    | 8  | 64  | 256  | 1e-01 | 30.81         | 2.015e-01  | 201.4     | 100        | 0.57               | 6.3         |
| 32  | pod    | 24 | 64  | 256  | 1e-01 | 35.47         | 5.462e-02  | 194.8     | 89         | 0.50               | 5.4         |
| 32  | pod    | 24 | 64  | 256  | 1e-02 | 37.85         | 5.462e-02  | 207.1     | 100        | 0.46               | 5.1         |
| 32  | pod    | 32 | 256 | 900  | 1e-01 | 41.84         | 3.778e-02  | 196.3     | 90         | 0.42               | 4.6         |
| 32  | pod    | 32 | 256 | 900  | 1e-03 | 45.30         | 3.777e-02  | 208.1     | 100        | 0.39               | 4.3         |
...
| 256 | coord  | 6  | 64  | 256  | 1e-01 | 276.28        | 2.468e-02  | 134.1     | 10         | 0.57               | 6.7         |
| 256 | coord  | 12 | 64  | 256  | 1e-01 | 320.31        | 2.133e-02  | 134.4     | 4          | 0.49               | 5.8         |
...
| 256 | pod    | 4  | 64  | 256  | 1e-03 | 31.70         | 4.012e-01  | 198.2     | 100        | 4.99               | 58.2        |
| 256 | pod    | 8  | 64  | 256  | 1e-03 | 31.77         | 2.190e-01  | 201.1     | 100        | 4.98               | 58.0        |
| 256 | pod    | 12 | 64  | 256  | 1e-02 | 35.81         | 1.459e-01  | 203.6     | 100        | 4.42               | 51.5        |
| 256 | pod    | 16 | 64  | 256  | 1e-01 | 36.58         | 1.035e-01  | 204.9     | 100        | 4.33               | 50.4        |
| 256 | pod    | 24 | 64  | 256  | 1e-01 | 39.15         | 6.497e-02  | 197.4     | 92         | 4.04               | 47.1        |
| 256 | pod    | 24 | 64  | 256  | 1e-02 | 44.69         | 6.497e-02  | 206.3     | 100        | 3.54               | 41.3        |
| 256 | pod    | 32 | 256 | 1024 | 1e-02 | 45.02         | 4.748e-02  | 208.4     | 100        | 3.51               | 41.0        |
...
| 64  | coord  | 12 | 64 | 256 | 1e-01 | 138.45        | 1.936e-02  | 127.1     | 1          | 0.21               | 2.4         |
| 128 | coord  | 8  | 64 | 256 | 1e-01 | 146.62        | 2.386e-02  | 127.9     | 6          | 0.53               | 7.1         |
| 256 | coord  | 8  | 64 | 256 | 1e-01 | 290.41        | 2.541e-02  | 136.6     | 9          | 0.54               | 6.4         |
| 256 | coord  | 12 | 64 | 256 | 1e-01 | 320.31        | 2.133e-02  | 134.4     | 4          | 0.49               | 5.8         |
...
| 512 | 1                        | 2                      | split | 1.178e-02                   | k=16 | 5.032e-02                 | k=32 |
...
|---------------|-----|------------------------|-----------|-----------------------|----------------|--------------------------------------|
| 2e-02         | 32  | 3.30 (k=16, tau=1e-02) | unreached | 1.14                  | 3.61           | 0.35                                 |
| 2e-02         | 64  | 3.43 (k=16, tau=1e-02) | unreached | 2.21                  | 7.17           | 0.65                                 |
| 2e-02         | 128 | 3.62 (k=16, tau=1e-02) | unreached | 3.74                  | 14.74          | 1.03                                 |
| 2e-02         | 256 | 4.57 (k=16, tau=1e-02) | unreached | 7.85                  | 29.75          | 1.63                                 |
| 2e-02         | 512 | 7.86 (k=16, tau=1e-02) | unreached | 26.54                 | 93.06          | 3.03                                 |
| 1e-02         | 32  | unreached              | unreached | 1.14                  | 3.61           | --                                   |
| 1e-02         | 64  | unreached              | unreached | 2.21                  | 7.17           | --                                   |
| 1e-02         | 128 | unreached              | unreached | 4.53                  | 14.74          | --                                   |
| 1e-02         | 256 | unreached              | unreached | 9.47                  | 29.75          | --                                   |
...
| target rel-L2 | N   | coord ms  | pod ms    | FOM ms (iso-accuracy) | FOM ms (exact) | best ROM speedup vs iso-accuracy FOM |
|---------------|-----|-----------|-----------|-----------------------|----------------|--------------------------------------|
| 5e-02         | 32  | unreached | unreached | 17.56                 | 193.24         | --                                   |
| 5e-02         | 64  | unreached | unreached | 28.77                 | 335.75         | --                                   |
| 5e-02         | 128 | unreached | unreached | 77.54                 | 1037.32        | --                                   |
| 5e-02         | 256 | unreached | unreached | 158.21                | 1844.33        | --                                   |
| 2e-02         | 32  | unreached | unreached | 17.56                 | 193.24         | --                                   |
| 2e-02         | 64  | unreached | unreached | 28.77                 | 335.75         | --                                   |
| 2e-02         | 128 | unreached | unreached | 77.54                 | 1037.32        | --                                   |
| 2e-02         | 256 | unreached | unreached | 158.21                | 1844.33        | --                                   |
...
|-----------|--------|-----|----|-------|----------|-----------------|-------|-----------|------------------|--------|
| burgers2d | coord  | 32  | 6  | 1e-01 | 103.27   | 95.79           | 0.93  | 2.099e-02 | 2.099e-02        | pax049 |
| burgers2d | coord  | 32  | 6  | 1e-02 | 271.10   | 254.15          | 0.94  | 1.692e-02 | 1.692e-02        | pax049 |
| burgers2d | coord  | 32  | 8  | 1e-02 | 333.66   | 306.17          | 0.92  | 1.623e-02 | 1.623e-02        | pax049 |
| burgers2d | coord  | 32  | 12 | 1e-02 | 443.31   | 404.84          | 0.91  | 1.172e-02 | 1.172e-02        | pax049 |
| burgers2d | coord  | 32  | 32 | 1e-02 | 6102.02  | 5286.84         | 0.87  | 7.679e-03 | 7.679e-03        | pax049 |
| burgers2d | coord  | 32  | 32 | 1e-03 | 6104.53  | 5285.16         | 0.87  | 7.568e-03 | 7.568e-03        | pax049 |
| burgers2d | coord  | 64  | 6  | 1e-01 | 106.43   | 105.63          | 0.99  | 2.238e-02 | 2.238e-02        | pax049 |
| burgers2d | coord  | 64  | 6  | 1e-02 | 264.66   | 263.28          | 0.99  | 1.783e-02 | 1.783e-02        | pax049 |
| burgers2d | coord  | 64  | 8  | 1e-01 | 116.72   | 117.41          | 1.01  | 2.071e-02 | 2.071e-02        | pax049 |
| burgers2d | coord  | 64  | 8  | 1e-02 | 316.13   | 314.35          | 0.99  | 1.579e-02 | 1.579e-02        | pax049 |
| burgers2d | coord  | 64  | 8  | 1e-03 | 317.27   | 314.43          | 0.99  | 1.579e-02 | 1.579e-02        | pax049 |
| burgers2d | coord  | 64  | 12 | 1e-01 | 138.45   | 137.98          | 1.00  | 1.936e-02 | 1.936e-02        | pax049 |
| burgers2d | coord  | 64  | 12 | 1e-02 | 434.80   | 433.39          | 1.00  | 1.265e-02 | 1.265e-02        | pax049 |
| burgers2d | coord  | 64  | 16 | 1e-02 | 592.45   | 588.38          | 0.99  | 1.180e-02 | 1.180e-02        | pax049 |
| burgers2d | coord  | 64  | 16 | 1e-03 | 594.23   | 590.60          | 0.99  | 1.177e-02 | 1.177e-02        | pax049 |
| burgers2d | coord  | 64  | 32 | 1e-03 | 6415.27  | 6336.30         | 0.99  | 9.383e-03 | 9.383e-03        | pax049 |
| burgers2d | coord  | 64  | 32 | 1e-02 | 6418.51  | 6334.27         | 0.99  | 9.383e-03 | 9.383e-03        | pax049 |
| burgers2d | coord  | 128 | 6  | 1e-01 | 138.96   | 138.33          | 1.00  | 2.390e-02 | 2.390e-02        | pax049 |
| burgers2d | coord  | 128 | 6  | 1e-03 | 299.53   | 297.68          | 0.99  | 1.898e-02 | 1.898e-02        | pax049 |
| burgers2d | coord  | 128 | 8  | 1e-01 | 146.62   | 146.46          | 1.00  | 2.386e-02 | 2.386e-02        | pax049 |
| burgers2d | coord  | 128 | 8  | 1e-02 | 342.61   | 343.61          | 1.00  | 1.672e-02 | 1.672e-02        | pax049 |
| burgers2d | coord  | 128 | 12 | 1e-02 | 467.09   | 465.29          | 1.00  | 1.426e-02 | 1.426e-02        | pax049 |
| burgers2d | coord  | 128 | 12 | 1e-03 | 467.91   | 466.47          | 1.00  | 1.426e-02 | 1.426e-02        | pax049 |
| burgers2d | coord  | 128 | 32 | 1e-03 | 6256.10  | 6240.08         | 1.00  | 9.640e-03 | 9.640e-03        | pax049 |
| burgers2d | coord  | 256 | 6  | 1e-01 | 276.28   | 262.21          | 0.95  | 2.468e-02 | 2.468e-02        | pax049 |
| burgers2d | coord  | 256 | 6  | 1e-02 | 471.02   | 427.54          | 0.91  | 2.000e-02 | 2.000e-02        | pax049 |
| burgers2d | coord  | 256 | 8  | 1e-02 | 521.31   | 473.17          | 0.91  | 1.761e-02 | 1.761e-02        | pax049 |
| burgers2d | coord  | 256 | 12 | 1e-01 | 320.31   | 299.02          | 0.93  | 2.133e-02 | 2.133e-02        | pax049 |
| burgers2d | coord  | 256 | 12 | 1e-02 | 668.88   | 610.86          | 0.91  | 1.489e-02 | 1.489e-02        | pax049 |
| burgers2d | coord  | 256 | 12 | 1e-03 | 678.56   | 612.05          | 0.90  | 1.489e-02 | 1.489e-02        | pax049 |
| burgers2d | coord  | 256 | 16 | 1e-02 | 824.30   | 739.00          | 0.90  | 1.451e-02 | 1.451e-02        | pax049 |
| burgers2d | coord  | 256 | 16 | 1e-03 | 826.21   | 740.22          | 0.90  | 1.444e-02 | 1.444e-02        | pax049 |
| burgers2d | coord  | 256 | 32 | 1e-03 | 7388.05  | 6721.43         | 0.91  | 1.037e-02 | 1.037e-02        | pax049 |
| burgers2d | pod    | 32  | 8  | 1e-01 | 30.81    | 31.09           | 1.01  | 2.015e-01 | 2.015e-01        | pax049 |
| burgers2d | pod    | 32  | 24 | 1e-01 | 35.47    | 35.64           | 1.00  | 5.462e-02 | 5.462e-02        | pax049 |
| burgers2d | pod    | 32  | 24 | 1e-02 | 37.85    | 36.89           | 0.97  | 5.462e-02 | 5.462e-02        | pax049 |
| burgers2d | pod    | 32  | 32 | 1e-01 | 41.84    | 40.11           | 0.96  | 3.778e-02 | 3.778e-02        | pax049 |
| burgers2d | pod    | 32  | 32 | 1e-03 | 45.30    | 42.88           | 0.95  | 3.777e-02 | 3.777e-02        | pax049 |
| burgers2d | pod    | 32  | 32 | 1e-02 | 45.39    | 43.34           | 0.95  | 3.777e-02 | 3.777e-02        | pax049 |
| burgers2d | pod    | 64  | 8  | 1e-01 | 32.19    | 33.46           | 1.04  | 2.103e-01 | 2.103e-01        | pax049 |
| burgers2d | pod    | 64  | 12 | 1e-02 | 33.29    | 35.63           | 1.07  | 1.368e-01 | 1.368e-01        | pax049 |
| burgers2d | pod    | 64  | 16 | 1e-02 | 34.19    | 35.15           | 1.03  | 9.667e-02 | 9.667e-02        | pax049 |
| burgers2d | pod    | 64  | 24 | 1e-01 | 37.16    | 35.45           | 0.95  | 5.937e-02 | 5.937e-02        | pax049 |
| burgers2d | pod    | 64  | 24 | 1e-02 | 39.77    | 37.76           | 0.95  | 5.937e-02 | 5.937e-02        | pax049 |
| burgers2d | pod    | 64  | 32 | 1e-01 | 42.97    | 41.73           | 0.97  | 4.221e-02 | 4.221e-02        | pax049 |
| burgers2d | pod    | 64  | 32 | 1e-03 | 45.10    | 46.58           | 1.03  | 4.221e-02 | 4.221e-02        | pax049 |
| burgers2d | pod    | 64  | 32 | 1e-02 | 45.17    | 46.52           | 1.03  | 4.221e-02 | 4.221e-02        | pax049 |
| burgers2d | pod    | 128 | 8  | 1e-01 | 30.99    | 30.12           | 0.97  | 2.158e-01 | 2.158e-01        | pax049 |
| burgers2d | pod    | 128 | 16 | 1e-01 | 35.39    | 34.61           | 0.98  | 1.010e-01 | 1.010e-01        | pax049 |
| burgers2d | pod    | 128 | 24 | 1e-01 | 37.05    | 36.42           | 0.98  | 6.273e-02 | 6.273e-02        | pax049 |
| burgers2d | pod    | 128 | 24 | 1e-02 | 38.53    | 39.47           | 1.02  | 6.273e-02 | 6.273e-02        | pax049 |
| burgers2d | pod    | 128 | 32 | 1e-01 | 41.12    | 39.66           | 0.96  | 4.553e-02 | 4.553e-02        | pax049 |
| burgers2d | pod    | 128 | 32 | 1e-02 | 47.64    | 43.60           | 0.92  | 4.553e-02 | 4.553e-02        | pax049 |
| burgers2d | pod    | 256 | 4  | 1e-03 | 31.70    | 33.10           | 1.04  | 4.012e-01 | 4.012e-01        | pax049 |
| burgers2d | pod    | 256 | 8  | 1e-03 | 31.77    | 30.85           | 0.97  | 2.190e-01 | 2.190e-01        | pax049 |
| burgers2d | pod    | 256 | 12 | 1e-02 | 35.81    | 36.20           | 1.01  | 1.459e-01 | 1.459e-01        | pax049 |
| burgers2d | pod    | 256 | 16 | 1e-01 | 36.58    | 38.69           | 1.06  | 1.035e-01 | 1.035e-01        | pax049 |
| burgers2d | pod    | 256 | 24 | 1e-01 | 39.15    | 36.60           | 0.93  | 6.497e-02 | 6.497e-02        | pax049 |
| burgers2d | pod    | 256 | 24 | 1e-02 | 44.69    | 39.78           | 0.89  | 6.497e-02 | 6.497e-02        | pax049 |
| burgers2d | pod    | 256 | 32 | 1e-02 | 45.02    | 47.09           | 1.05  | 4.748e-02 | 4.748e-02        | pax049 |
| poisson2d | coord  | 32  | 4  | 1e-01 | 1.71     | 1.67            | 0.98  | 8.405e-02 | 8.405e-02        | pax007 |
| poisson2d | coord  | 32  | 16 | 1e-01 | 2.42     | 2.41            | 1.00  | 7.673e-02 | 7.673e-02        | pax007 |
| poisson2d | coord  | 32  | 16 | 1e-02 | 3.29     | 3.30            | 1.00  | 1.301e-02 | 1.301e-02        | pax007 |
| poisson2d | coord  | 64  | 4  | 1e-01 | 1.82     | 1.84            | 1.01  | 8.372e-02 | 8.372e-02        | pax007 |
| poisson2d | coord  | 64  | 16 | 1e-02 | 3.42     | 3.43            | 1.00  | 1.155e-02 | 1.155e-02        | pax007 |
| poisson2d | coord  | 128 | 4  | 1e-01 | 2.06     | 2.07            | 1.00  | 8.514e-02 | 8.514e-02        | pax007 |
| poisson2d | coord  | 128 | 16 | 1e-02 | 3.64     | 3.62            | 1.00  | 1.150e-02 | 1.150e-02        | pax007 |
| poisson2d | coord  | 256 | 4  | 1e-01 | 3.16     | 3.02            | 0.96  | 8.300e-02 | 8.300e-02        | pax007 |
| poisson2d | coord  | 256 | 16 | 1e-02 | 4.80     | 4.57            | 0.95  | 1.127e-02 | 1.127e-02        | pax007 |
| poisson2d | coord  | 512 | 4  | 1e-01 | 7.26     | 6.39            | 0.88  | 9.325e-02 | 9.325e-02        | pax007 |
| poisson2d | coord  | 512 | 8  | 1e-01 | 7.74     | 6.70            | 0.87  | 8.127e-02 | 8.127e-02        | pax007 |
| poisson2d | coord  | 512 | 16 | 1e-02 | 8.75     | 7.86            | 0.90  | 1.178e-02 | 1.178e-02        | pax007 |
| poisson2d | pod    | 32  | 24 | 1e-01 | 0.37     | 0.34            | 0.94  | 6.946e-02 | 6.946e-02        | pax007 |
| poisson2d | pod    | 32  | 32 | 1e-01 | 0.39     | 0.37            | 0.95  | 5.367e-02 | 5.367e-02        | pax007 |
| poisson2d | pod    | 64  | 24 | 1e-01 | 0.35     | 0.34            | 0.97  | 6.678e-02 | 6.678e-02        | pax007 |
| poisson2d | pod    | 64  | 32 | 1e-01 | 0.37     | 0.37            | 1.00  | 5.105e-02 | 5.105e-02        | pax007 |
| poisson2d | pod    | 128 | 24 | 1e-01 | 0.41     | 0.44            | 1.07  | 6.620e-02 | 6.620e-02        | pax007 |
| poisson2d | pod    | 128 | 32 | 1e-01 | 0.46     | 0.49            | 1.08  | 5.049e-02 | 5.049e-02        | pax007 |
| poisson2d | pod    | 256 | 24 | 1e-01 | 0.47     | 0.47            | 0.99  | 6.605e-02 | 6.605e-02        | pax007 |
| poisson2d | pod    | 256 | 32 | 1e-01 | 0.75     | 0.56            | 0.74  | 5.035e-02 | 5.035e-02        | pax007 |
| poisson2d | pod    | 512 | 24 | 1e-01 | 0.77     | 0.52            | 0.68  | 6.602e-02 | 6.602e-02        | pax007 |
...
| pod    | 512 | 6.90e-07 | 5.24e-06 | 5.97e-06 | 8.26e-06 | 2.06e-05 | 4.19e-05 | 9.85e-05 | 1.59e-05 |
...
| burgers2d | 32  | 6656      | 2.2e-15       | 3.683e-01 | 2.493e-01 | 1.901e-01 | 1.200e-01 | 8.515e-02 | 5.158e-02 | 3.558e-02 |
| burgers2d | 64  | 6656      | 1.8e-15       | 3.760e-01 | 2.574e-01 | 1.981e-01 | 1.274e-01 | 9.092e-02 | 5.611e-02 | 3.929e-02 |
| burgers2d | 128 | 6656      | 2.0e-14       | 3.805e-01 | 2.623e-01 | 2.029e-01 | 1.322e-01 | 9.462e-02 | 5.911e-02 | 4.205e-02 |
| burgers2d | 256 | 6656      | 1.8e-14       | 3.830e-01 | 2.650e-01 | 2.057e-01 | 1.349e-01 | 9.679e-02 | 6.091e-02 | 4.368e-02 |
...
| burgers2d | pod_projection_floor | 64  | -- | --  | --   | --    | --      | --       | --         | --         | --         | oracle_floor    |
| burgers2d | pod_projection_floor | 128 | -- | --  | --   | --    | --      | --       | --         | --         | --         | oracle_floor    |
| burgers2d | coord_uncapped_pool  | 128 | 8  | 64  | 256  | 1e-01 | 156.589 | 114.863  | 2.379e-02  | 7          | 7.39e-03   | cap_control     |
| burgers2d | pod_uncapped_pool    | 128 | 8  | 64  | 256  | 1e-01 | 31.356  | 31.299   | 2.158e-01  | 100        | 2.09e-04   | cap_control     |
| burgers2d | pod_projection_floor | 256 | -- | --  | --   | --    | --      | --       | --         | --         | --         | oracle_floor    |
...
| poisson2d | coord_uncapped_pool  | 128 | 8  | 64  | 256  | 1e-01 | 2.414   | --       | 9.791e-02  | 0          | 1.38e-03   | cap_control     |
| poisson2d | coord_uncapped_pool  | 128 | 8  | 64  | 256  | 1e-02 | 3.297   | --       | 1.313e-02  | 6          | 1.38e-03   | cap_control     |
| poisson2d | pod_uncapped_pool    | 128 | 8  | 64  | 256  | 1e-01 | 0.994   | --       | 1.763e-01  | 75         | 9.23e-06   | cap_control     |
| poisson2d | pod_uncapped_pool    | 128 | 8  | 64  | 256  | 1e-02 | 1.204   | --       | 1.763e-01  | 100        | 9.23e-06   | cap_control     |
