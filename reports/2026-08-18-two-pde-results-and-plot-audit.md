...
| Burgers-2D | full grid | 1.654e-02  | 1.000x     | 70.9      | 1.000x    | <br />--  |
...
| Poisson N | ROM error | ROM ms | Matched FOM error | Matched FOM ms | Speedup |
| --------- | --------- | ------ | ----------------- | -------------- | ------- |
| 32        | 1.301e-02 | 3.303  | 8.091e-03         | 1.145          | 0.347x  |
| 64        | 1.155e-02 | 3.431  | 5.761e-03         | 2.218          | 0.646x  |
| 128       | 1.150e-02 | 3.624  | 4.063e-03         | 4.559          | 1.258x  |
| 256       | 1.127e-02 | 4.571  | 1.065e-02         | 7.907          | 1.730x  |
| 512       | 1.178e-02 | 7.865  | 7.104e-03         | 26.650         | 3.388x  |

| PDE        | N   | ROM tau   | FOM tau   | Baseline ms | Hybrid ms | Speedup |
| ---------- | --- | --------- | --------- | ----------- | --------- | ------- |
| Poisson-2D | 32  | 5.000e-01 | 1.000e-06 | 2.425       | 4.075     | 0.595x  |
| Poisson-2D | 64  | 5.000e-01 | 1.000e-06 | 4.821       | 6.769     | 0.712x  |
| Poisson-2D | 128 | 1.000e-01 | 1.000e-06 | 10.047      | 12.086    | 0.831x  |
| Poisson-2D | 256 | 1.000e-02 | 1.000e-06 | 19.852      | 22.584    | 0.879x  |
| Poisson-2D | 512 | 1.000e-02 | 1.000e-06 | 61.705      | 66.132    | 0.933x  |
| Burgers-2D | 32  | 1.000e-09 | 1.000e-06 | 47.625      | 327.778   | 0.145x  |
| Burgers-2D | 64  | 1.000e-09 | 1.000e-06 | 85.559      | 395.354   | 0.216x  |
| Burgers-2D | 128 | 1.000e-09 | 1.000e-06 | 228.057     | 580.511   | 0.393x  |
| Burgers-2D | 256 | 1.000e-09 | 1.000e-06 | 449.884     | 914.526   | 0.492x  |
...
| FOM tolerance | Poisson q1024 ms | Poisson zero-CG ms | Poisson speedup | Burgers cubic / corrected ms | Burgers speedup | Burgers verdict            |
| ------------- | ---------------- | ------------------ | --------------- | ---------------------------- | --------------- | -------------------------- |
| 1e-06         | 1.921            | 1533.607           | 798.3x          | 532.817 / 343.673            | 1.550x          | supported faster           |
| 1e-08         | 2.470            | 1787.715           | 723.8x          | 923.747 / 927.397            | 0.996x          | unsupported / inconclusive |
| 1e-10         | 3.734            | 1991.052           | 533.3x          | 1191.344 / 1209.532          | 0.985x          | unsupported / inconclusive |
