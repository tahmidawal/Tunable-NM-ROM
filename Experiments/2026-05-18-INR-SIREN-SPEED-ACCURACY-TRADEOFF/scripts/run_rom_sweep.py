...
from tunable_rom_speed.autoencoder_vdf import INRAutoencoderVDF
from tunable_rom_speed.fom.poisson_cg import PoissonFOM, source_field, analytical_u
...
def _run_one(decoder_label, ckpt_path: Path, eq_path: Path, data: dict, args, gn_max_iters: int = 12):
    ...
    if args.warm_start:
        ...
        from tunable_rom_speed.fom.poisson_cg import analytical_u as _ana
        for i in range(n_test):
