...
the job ran; the stricter flag is printed beside it in Table~\ref{tab:panel-all}.

\subsection{What the method is, stated once}
\label{app:method:statements}
...
least-squares problem, not a linear system in $\latent_{n+1}$; no latent mass
