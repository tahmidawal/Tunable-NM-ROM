...
panels are retained in Table~\ref{tab:panel-main}.

\begin{table}[htbp]
\centering
\caption{Burgers2D at $256^2$, development. Worst evolved and all-times
...
limits control numerical work. Table~\ref{tab:controls-main} separates
...
establish EQ acceleration. Figure~\ref{fig:family} and the full
