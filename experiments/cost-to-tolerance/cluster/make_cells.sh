...
PGRID="KS=2,4,6,8,12,16,24,32 TAUS=1e-1,1e-2,1e-3 M=64 MQ=256 M_BIG=256 K_BIG=32 MQ_SUPP=512 DO_SUPP=1 POOL_CONTROL=1 N_TEST=16 GN_ITERS=60 TIME_REPS=7 TIME_WARM=2 PKL_DIR=../ckpt"
BGRID="N=64 KS=2,4,6,8,12,16,24,32 TAUS=1e-1,1e-2,1e-3 M=64 MQ=256 M_BIG=256 K_BIG=32 MQ_SUPP=512 DO_SUPP=1 CTOL_N_TEST=16 N_POD_TRAJ=512 POD_SLICE_STRIDE=4 TIME_REPS=7 TIME_WARM=2 GEN_CHUNK=16 PKL_DIR=../ckpt"
