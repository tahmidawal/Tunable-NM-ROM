"""End-to-end smoke test for the symmetric-ViT Heat NM-ROM on tiny N=8 2D.

Verifies that the entire pipeline (FOM, ViT autoencoder init, decode,
EQ NNLS, NM-ROM solve) runs without crashing. Does NOT validate
accuracy.
"""
...
from tunable_rom_vit_heat.fom.heat import (
    HeatFOM,
    NUM_STEPS,
    sample_parameters,
    generate_trajectory,
)
from tunable_rom_vit_heat.models.autoencoder import ViTViTAutoencoder
from tunable_rom_vit_heat.eq.nnls import compute_eq_weights, build_v_eq
from tunable_rom_vit_heat.solver.nm_rom import NMROMSolver
