...
\begin{table}[t]
\centering
\caption{Comparison with other nonlinear-manifold ROMs on shared data
...
Table~\ref{tab:headline-times} lists, for every row of
Table~\ref{tab:headline}, the correction rank and residual evaluation of
...
error (Table~\ref{tab:figure1-table}). The iteration cap
