...
measured and rows reserved for runs in progress. Times and settings: Table~\ref{tab:headline-times}.}
\label{tab:headline}
...
FOM at every mesh (\S\ref{sec:results:tunability} gives the cost of each
rank).
