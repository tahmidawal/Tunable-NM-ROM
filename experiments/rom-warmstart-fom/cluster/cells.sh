...
bash "$MK" wsp_cons 120G 8 "$PENV NS=32,64,128,256,512 RUN_ROLE=consolidated" \
  "\$PY wsf_poisson.py ../../out/wsp_cons.json" "$GPU" >/dev/null
echo "built wsp_cons"
bash "$MK" wsb_cons 120G 16 "$BENV NS=32,64,128,256 RUN_ROLE=consolidated" \
