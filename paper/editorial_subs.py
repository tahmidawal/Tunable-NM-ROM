...
SUBS = {
    'T01_problems': [
        ...
        ('6 development cases; 32 held-out (tuning); sealed cohort opened once (job 3804465)',
         '6 development cases; 32 validation; 64 held-out at $2048^2$, $4096^2$; sealed cohort opened once'),
    ...
    'T08_solver_knobs': [('worst \\% (32 held-out)', 'worst \\% (32 validation)'), ('worst % (32 held-out)', 'worst % (32 validation)'),(r'FOM $128^2$, $\Delta t{=}0.005$ & 9.849 & 21.2 & 0/96 \\' + '\n', ''),
    ...
    'T13b_sealed_verdicts': [('incumbent', 'original'), ('b-seeds sealed cohort', 'sealed cohort'),
                             ('every rung converged', 'every setting converged'), ('knob bar', 'secondary criterion'),
                             (r'\texttt{seed1}', 'first seed'), (r'\texttt{seed2}', 'second seed'), (r'\texttt{seed3}', 'third seed'),
                             ('`seed1`', 'first seed'), ('`seed2`', 'second seed'), ('`seed3`', 'third seed'), (r'\texttt{original}', 'original'), ('`original`', 'original')],
