...
(Table~\ref{tab:headline-times}). This variant is slower than the
...
Table~\ref{tab:headline}, or the confirmed variant of the
$4096^2$ Burgers lattice rule with an exact residual at the first step.
For the $4096^2$ Burgers fast speedup in Table~\ref{tab:headline}, the
