...
On Burgers, Table~\ref{tab:burgers-comparison} reports NM-ROM, POD and
...
accuracy (Table~\ref{tab:operators}); missing paired timings for that
...
The newer high-resolution panels remain in Table~\ref{tab:panel-main}.
...
Appendix~\ref{app:main-experiment-details}; in particular, Transolver's
...
\input{tables/TR_lshape_cg_main}
\end{table}
...
(Tables~\ref{tab:head-burgers} and \ref{tab:head-poisson}). For linear
