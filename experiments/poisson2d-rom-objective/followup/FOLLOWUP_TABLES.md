...
### k ladder — coordinate ROM vs POD at the same k (N=64, hard-BC, weak_a1_M64, NNLS-EQ m=256)

ACCURACY protocol: nearest init, mean rel-L2 over the 16 held-out sources, LM budget 60.  The POD columns are FULL-GRID objectives (exact minimisers, the problem being quadratic in the POD coefficients) and are therefore comparable to the coordinate ROM's full-grid column; the coordinate EQ columns use a hyper-reduced quadrature.
...
Medians over the 16 sources (the means above carry heavy tails): k=2: full 1.13e-01 / EQ-grid 1.13e-01 / EQ-meshfree 1.13e-01, k=4: full 1.44e-02 / EQ-grid 1.43e-02 / EQ-meshfree 1.47e-02, k=6: full 8.40e-03 / EQ-grid 8.50e-03 / EQ-meshfree 8.37e-03, k=8: full 6.20e-03 / EQ-grid 6.33e-03 / EQ-meshfree 6.72e-03, k=12: full 5.14e-03 / EQ-grid 6.40e-03 / EQ-meshfree 6.23e-03, k=16: full 4.19e-03 / EQ-grid 4.68e-03 / EQ-meshfree 5.35e-03, k=24: full 3.88e-03 / EQ-grid 4.45e-03 / EQ-meshfree 4.91e-03, k=32: full 3.67e-03 / EQ-grid 5.43e-03 / EQ-meshfree 6.80e-03.

Solves that ended on the LM BUDGET rather than converging (out of 16, full grid / EQ grid / EQ meshfree / FD control): k=2: 2/2/1/5, k=4: 0/0/0/2, k=6: 1/2/1/2, k=8: 1/1/1/3, k=12: 1/0/1/3, k=16: 1/2/0/3, k=24: 3/2/2/9, k=32: 5/7/10/12.  Budget terminations are INCLUDED in the means above (nothing is dropped).
...
Accuracy columns: nearest init, mean over the 16 held-out sources (medians in brackets).  Cost columns: the `pt_m` cell, mean init, timed on source 0.  The retained mode count M' differs between the on-grid (discrete eigenvalues) and meshfree (continuum eigenvalues) arms because their degeneracy patterns differ, so it is listed per arm.

| M (requested) | M' (full/grid, meshfree) | m | full grid | NNLS-EQ grid | NNLS-EQ meshfree | ms/solve full | ms/solve EQ (meshfree) |
|---|---|---|---|---|---|---|---|
| 16 | 17, 17 | 64 | 1.49e-02 [1.10e-02] | 3.03e-02 [2.71e-02] | 3.79e-02 [2.79e-02] | 20.1 | 6.7 |
| 32 | 32, 33 | 128 | 9.53e-03 [7.24e-03] | 1.34e-02 [9.08e-03] | 1.44e-02 [1.07e-02] | 45.3 | 14.8 |
| 64 | 64, 64 | 256 | 7.65e-03 [6.20e-03] | 8.66e-03 [6.33e-03] | 8.98e-03 [6.72e-03] | 35.6 | 11.5 |
| 128 | 129, 129 | 512 | 7.17e-03 [6.01e-03] | 7.28e-03 [6.01e-03] | 7.42e-03 [6.09e-03] | 38.1 | 16.6 |
| 256 | 257, 257 | 1024 | 7.13e-03 [6.00e-03] | 7.13e-03 [6.00e-03] | 7.25e-03 [6.10e-03] | 47.4 | 23.9 |
