<!-- GENERATED by paper/gen_tables.py from b-seeds sealed cohort, job 3804465 (A100-40GB), dense M = 4(K+q); sealed worst evolved error per rung for the incumbent and the seed mean +- sample std beside the development seed mean; C2 ratios from the lane; unconverged rungs marked -- do not edit -->
