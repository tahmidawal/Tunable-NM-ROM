...
# 2026-09-21 user decision: Figures 1-2 replaced by tables (Figure 1 dropped as a duplicate of Table 1; Figure 2 -> tab:tunability)
for label in ('tab:headline','tab:failures','tab:tunability'):
