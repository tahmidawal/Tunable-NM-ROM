...
This report covers newly verified absorbing and fixed-wall scalar waves, learned-bank reconstruction and actual reduced trajectories. The numerical results below are provisional pending independent result review; all earlier wave experiments are excluded from this evidence.
...
In `dirichlet`, the MLP has 28032 head parameters and the quadratic head has 9792; this is not a parameter-matched architecture comparison. The 2 optimizer repeats share the same data. The velocity penalty improves mean tangent fitting in 4 of 4 matched comparisons, while median trajectory energy-state error worsens in 1. Selected latent fits include 2 nonstationary states; these remain failures of the declared fitting gate.
In `absorbing`, the MLP has 28032 head parameters and the quadratic head has 9792; this is not a parameter-matched architecture comparison. The 2 optimizer repeats share the same data. The velocity penalty improves mean tangent fitting in 4 of 4 matched comparisons, while median trajectory energy-state error worsens in 3. Selected latent fits include 2 nonstationary states; these remain failures of the declared fitting gate.
...
| Boundary | Head/objective | Repeat seed | Primary step | Complete | Failed | Energy-state mean | Median | Worst | Energy outliers | Engineering target passed |
|---|---|---|---|---|---|---|---|---|---|---|
| dirichlet | mlp | 691200 | 0.0025 | 16 | 0 | 52.0431% | 52.4463% | 88.2216% | 16 | False |
| dirichlet | quadratic | 691200 | 0.0025 | 16 | 0 | 94.7100% | 93.3651% | 125.2853% | 16 | False |
| dirichlet | mlp_velocity | 691200 | 0.0025 | 16 | 0 | 50.2322% | 47.2399% | 85.5976% | 16 | False |
| dirichlet | quadratic_velocity | 691200 | 0.0025 | 16 | 0 | 99.1550% | 99.0776% | 140.6889% | 16 | False |
| dirichlet | mlp | 691201 | 0.0025 | 16 | 0 | 53.3361% | 46.8803% | 90.4396% | 16 | False |
| dirichlet | quadratic | 691201 | 0.0025 | 16 | 0 | 103.3495% | 106.9539% | 143.3168% | 16 | False |
| dirichlet | mlp_velocity | 691201 | 0.0025 | 16 | 0 | 48.7336% | 40.2908% | 104.2528% | 16 | False |
| dirichlet | quadratic_velocity | 691201 | 0.0025 | 16 | 0 | 101.4157% | 105.8670% | 137.2699% | 16 | False |
| absorbing | mlp | 691200 | 0.0025 | 16 | 0 | 10.5092% | 8.4457% | 21.0070% | 6 | False |
| absorbing | quadratic | 691200 | 0.0025 | 16 | 0 | 12.8630% | 10.2798% | 22.2061% | 8 | False |
| absorbing | mlp_velocity | 691200 | 0.0025 | 16 | 0 | 10.4612% | 8.5338% | 21.9181% | 5 | False |
| absorbing | quadratic_velocity | 691200 | 0.0025 | 16 | 0 | 22.0002% | 18.3759% | 50.2425% | 15 | False |
| absorbing | mlp | 691201 | 0.0025 | 16 | 0 | 10.9007% | 8.5550% | 22.1054% | 6 | False |
| absorbing | quadratic | 691201 | 0.0025 | 16 | 0 | 12.4900% | 10.3322% | 22.4108% | 9 | False |
| absorbing | mlp_velocity | 691201 | 0.0025 | 16 | 0 | 9.7171% | 8.2816% | 20.1485% | 4 | False |
| absorbing | quadratic_velocity | 691201 | 0.0025 | 16 | 0 | 17.4163% | 17.7051% | 28.6702% | 14 | False |

| Boundary | Head/objective | Repeat seed | Displacement mean | Median | Worst | Outliers | Velocity mean | Median | Worst | Outliers |
|---|---|---|---|---|---|---|---|---|---|---|
| dirichlet | mlp | 691200 | 25.6972% | 24.2567% | 49.2722% | 16 | 38.8123% | 36.6007% | 70.5927% | 16 |
| dirichlet | quadratic | 691200 | 62.4094% | 56.3384% | 112.6586% | 16 | 74.7327% | 70.9953% | 104.9053% | 16 |
| dirichlet | mlp_velocity | 691200 | 27.3134% | 25.6470% | 46.8490% | 16 | 37.4499% | 33.3184% | 59.9355% | 16 |
| dirichlet | quadratic_velocity | 691200 | 64.1521% | 63.7021% | 129.0170% | 16 | 75.7007% | 76.6735% | 113.4424% | 16 |
| dirichlet | mlp | 691201 | 26.8754% | 24.1144% | 52.6532% | 16 | 41.4513% | 37.2080% | 71.0360% | 16 |
| dirichlet | quadratic | 691201 | 64.4682% | 61.8926% | 99.8426% | 16 | 79.7171% | 83.9742% | 117.8620% | 16 |
| dirichlet | mlp_velocity | 691201 | 27.7261% | 19.6934% | 63.1175% | 16 | 35.9963% | 30.8878% | 71.9502% | 16 |
| dirichlet | quadratic_velocity | 691201 | 71.7351% | 69.7916% | 113.6356% | 16 | 79.4239% | 79.4803% | 113.2245% | 16 |
| absorbing | mlp | 691200 | 4.1619% | 3.5455% | 8.3603% | 0 | 7.5729% | 6.1527% | 15.1207% | 4 |
| absorbing | quadratic | 691200 | 6.1459% | 5.2964% | 12.4827% | 2 | 9.0215% | 7.2082% | 15.8810% | 5 |
| absorbing | mlp_velocity | 691200 | 4.8317% | 3.8323% | 9.6068% | 0 | 7.2230% | 5.8431% | 14.7459% | 4 |
| absorbing | quadratic_velocity | 691200 | 13.0673% | 8.7043% | 49.3420% | 7 | 16.2980% | 13.4975% | 38.3744% | 11 |
| absorbing | mlp | 691201 | 4.5467% | 3.5919% | 9.2488% | 0 | 8.2007% | 6.1796% | 17.3100% | 4 |
| absorbing | quadratic | 691201 | 5.9922% | 5.0185% | 12.5742% | 2 | 9.1329% | 7.2303% | 15.8036% | 6 |
| absorbing | mlp_velocity | 691201 | 4.1598% | 3.7370% | 7.7794% | 0 | 6.6304% | 5.8174% | 13.4047% | 2 |
| absorbing | quadratic_velocity | 691201 | 8.1571% | 8.5462% | 13.3012% | 5 | 12.2982% | 12.6805% | 19.9755% | 12 |
...
| absorbing | mlp | 691200 | 0.0000% | 0.0000% | 0.0000% | 16 | 16 | — | True | 0.44564522 | 5 |
| absorbing | quadratic | 691200 | 0.0000% | 0.0000% | 0.0000% | 16 | 16 | — | True | 1.1539816 | 23 |
...
| absorbing | mlp | 691201 | 0.0000% | 0.0000% | 0.0000% | 16 | 16 | — | True | 0.63145662 | 22 |
| absorbing | quadratic | 691201 | 0.0000% | 0.0000% | 0.0000% | 16 | 16 | — | True | 0.87440671 | 20 |
| absorbing | mlp_velocity | 691201 | 0.0000% | 0.0000% | 0.0001% | 16 | 16 | — | True | 0.77090954 | 10 |
| absorbing | quadratic_velocity | 691201 | 0.0001% | 0.0001% | 0.0001% | 16 | 16 | — | True | 1.9880072 | 29 |
...
| dirichlet | mlp_velocity | 691200 | 2.2483% | 1.9537% | 5.9863% | 0.0022267472 | 0.0001% |
...
| absorbing | mlp | 691200 | 2.1090% | 2.0029% | 5.0863% | 0.0003105915 | 0.0000% |
| absorbing | quadratic | 691200 | 2.2010% | 1.8668% | 4.9279% | 0.00029716461 | 0.0000% |
...
| absorbing | mlp | 691201 | 2.1931% | 2.0633% | 4.7764% | 0.00019527906 | 0.0000% |
| absorbing | quadratic | 691201 | 2.5136% | 2.1162% | 6.2738% | 0.00034798382 | 0.0000% |
| absorbing | mlp_velocity | 691201 | 1.6060% | 1.3682% | 4.0148% | 0.00023693167 | 0.0000% |
| absorbing | quadratic_velocity | 691201 | 1.8337% | 1.6104% | 4.0637% | 0.00038005507 | 0.0000% |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| reflective | quadratic | 691200 | False | True | 0.0000% | 0.0003125 | 16 | 0 | 94.7527% | 93.3685% | 125.9644% | 16 | False |
...
- Source result: `experiments/fresh-wave-head/runs/reflective01/out/campaign/result.json`; SHA-256 `5e282204d4e86827ee85e4801674b191c50acb56bbbee52e52b5ba632a3d5e28`; GPU job `3338483`; source commit `fdcc6491657363005cc9060a0cae21dac320a974`; devices `['NVIDIA A100-PCIE-40GB']`.
- Source result: `experiments/fresh-wave-head/runs/absorbing02/out/campaign/result.json`; SHA-256 `43477d18df7ea5644843c98673eba74499bbcf426cf82f8c15ea63581cb73aa3`; GPU job `3338658`; source commit `fdcc6491657363005cc9060a0cae21dac320a974`; devices `['NVIDIA H100 PCIe']`.
- Frozen-checkpoint continuation: `experiments/fresh-wave-head/runs/refquad20001/out/refinement/result.json`; SHA-256 `21849028f54fe25c4d4ac30ed20dc883ef325907e5fe81b5d750be9f0624efe8`; GPU job `3339304`; pinned mathematical source `fdcc6491657363005cc9060a0cae21dac320a974`.
