...
| F5 non-negativity | train, val and test truth, all $t \ge 1$ | $\min u \ge -10^{-9}$ | the same IC rolled with a central-difference advection stencil at $\nu = 0.01$, $A = 2$ (cell Péclet 6.25): $\min u < -10^{-3}$ |
